...
class AddVegetableDetailsScreen extends GetView<AddVegetableDetailsScreenController> {
  AddVegetableDetailsScreen({super.key});
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed: () async {
                                      if (controller.formKey.currentState!.validate()) {
                                        await controller.addVegetablesList();
